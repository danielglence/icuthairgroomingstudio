...
const gallery = [
  ...
  { src: "/manus-storage/i-cut-reference-studio_56526fca.jpg", alt: "Warm modern salon interior with styling stations and mirrors", label: "The studio" },
  { src: "/manus-storage/i-cut-reference-precision_59ace8d3.jpg", alt: "Close-up of a precise haircut being shaped with scissors", label: "Precision" },
  { src: "/manus-storage/i-cut-reference-tools_0f907ff3.jpg", alt: "Grooming tools arranged on a charcoal stone counter", label: "The details" },
  { src: "/manus-storage/i-cut-reference-beard_134b3543.jpg", alt: "Barber carefully shaping a short beard with a comb and trimmer", label: "Beard craft" },
  { src: "/manus-storage/i-cut-apex-inspired-hero_fdaf380c.jpg", alt: "Barber working on a client’s haircut in a dark studio", label: "In the chair" },
];
